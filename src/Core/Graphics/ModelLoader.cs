...
namespace WipeoutRewrite.Core.Graphics
{
    ...
    public class ModelLoader
    {
        ...
        private HashSet<short>? _primitiveTypesSeen; // Debug: track which types we encounter
        ...
        /// <summary>
        /// Creates a simple mock ship for testing when PRM loading fails
        /// </summary>
        public Mesh CreateMockShipModel(string name)
        {
            return CreateMockShipModelScaled(name, 1.0f);
        }

        /// <summary>
        /// Creates a mock ship model with scaled geometry - Wipeout-style futuristic racer
        /// </summary>
        public Mesh CreateMockShipModelScaled(string name, float scale = 1.0f)
        {
            var mesh = new Mesh(name)
            {
            ...
            _logger?.LogInformation("Created enhanced mock ship model with {VertCount} vertices, {PrimCount} primitives", 
        ...
        /// </summary>
        // Removed CreateSimpleMockShipModel — kept previous, more detailed mock generator instead.
    }
}
